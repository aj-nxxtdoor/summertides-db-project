...
Folder Structure
database/ Contains scripts used to build the database.

queries/ Contains all SQL exercises.

docs/ Contains supporting documentation such as the ER Diagram.

presentation/ Contains your project presentation.
...
03_insert_data.sql
04_constraints.sql
Continue through the queries folder.
Team Members
Name	Role
